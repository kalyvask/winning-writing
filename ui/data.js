...
export const PRINCIPLES = [
  ...
  },
  {
    ...
    items: [
      ...
      'Be vivid. Picture your favorite movie scene; describe it in words. That is the texture you want in a bio. The Scrimshaw card-counter opening ("We won in Vegas. Our game: exploiting biases.") is a movie scene.',
      ...
      'Happy endings beat unresolved trouble. Show yourself overcoming, not still mired. Jen McPhillips: "I was voted homecoming queen — something that still embarrasses me, but encapsulates how far I came."',
      ...
      'Six structural patterns (Kramon class examples): open in scene then arc back (Scrimshaw), provocative thesis then evidence (Legendy), alliterative opening (Scrimshaw bio 2), childhood frame (McPhillips), aspiration declared early (Houston), sensory open (Hanno).',
  ...
  },
  {
    ...
    source: 'Konrad rule 7 + Bryant + the Scrimshaw card-counter rewrite',
    items: [
      ...
      'The Scrimshaw before/after is the canonical example. Same person, same facts, four paragraphs of resume-dump → one cinematic Vegas scene + the Harvard arc as supporting context. Twice the impact.',
