...
export const BANNED_WORDS = {
  ...
  aiTells: [
    ...
    { find: /\bunlock(s|ed|ing)? (the |your )?(full )?(potential|value|power|insights)\b/gi, label: '"unlock the potential" (AI tic - nothing is locked)' },
    { find: /\belevat(e|es|ed|ing) (your|the|our)\b/gi, label: '"elevate your X" (AI tic)' },
    { find: /\b(the )?(landscape|realm) of\b/gi, label: '"the landscape/realm of" (AI tic)' },
    { find: /\b(a|is a) testament to\b/gi, label: '"a testament to" (AI tic)' },
    { find: /\bunderscor(e|es|ed|ing) the\b/gi, label: '"underscores the" (AI tic)' },
    { find: /\bembark on a journey\b/gi, label: '"embark on a journey" (AI tic)' },
    { find: /\b(ever|rapidly)[ -]evolving\b/gi, label: '"ever-evolving" (AI tic)' },
    { find: /\bstands as a\b/gi, label: '"stands as a" (AI tic)' },
    { find: /\b(circle back|touch base|sync up)\b/gi, label: 'consultant filler - name the actual next step' },
    { find: /\blow[ -]hanging fruit\b/gi, label: '"low-hanging fruit" - name the task' },
    { find: /\bmove the needle\b/gi, label: '"move the needle" - name the metric and the number' },
    { find: /\bboil the ocean\b/gi, label: '"boil the ocean" - consultant filler' },
    { find: /\btable stakes\b/gi, label: '"table stakes" - consultant filler' },
    { find: /\bbest[ -]in[ -]class\b/gi, label: '"best-in-class" - compared to what, measured how?' },
    { find: /\bdouble[ -]click on\b/gi, label: '"double-click on" - you are not a mouse' },
  ],
  coldEmailKillers: [
